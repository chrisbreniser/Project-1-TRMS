...
window.onload = function () {
    ...
    reimbursmentForm.action = "/form/reject/" + localStorage.formToReject;
    console.log("formToReject: " + localStorage.formToReject);

    //AJAX - Asynchronous JavaScript and XML
    //Initialize xhr object
    let xhr = new XMLHttpRequest();
    const url = "http://localhost:9090/form/" + localStorage.formToReject;
